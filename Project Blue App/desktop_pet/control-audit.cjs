...
const expectedButtonPanels = {
  ...
  securityScan: "systems",

  devRunAudit: "tools",
  devRunDoctor: "tools",
  devSystemInfo: "tools",
  devOpenProject: "tools",
  devFocusDiagnostics: "tools",
  devSecurityScan: "tools",
  devBlueMeshCheck: "tools",
  saveAutonomy: "tools",
  fullControlGrant: "tools",
  fullControlRevoke: "tools",
  phoneBridgeStarter: "tools",
  phoneApprovalQueueShow: "tools",
  phoneBridgeStart: "tools",
  phoneBridgeStop: "tools",
  doctor: "tools",
  systemInfo: "tools",
  openProject: "tools",
  pendingApprovals: "tools",
  auditEvents: "tools",
  pcActionGuidelines: "tools",
  pcActionRun: "tools",
  artifactRefresh: "tools",
  artifactOpen: "tools",
  artifactReveal: "tools",
