(() => {
  ...
  const editors = {
    ...
    run: [{ id: "tests", title: "Test Explorer", closable: false }, { id: "tasks", title: "Tasks", closable: true }, { id: "background-agents", title: "Background Agents", closable: true }, { id: "debugger", title: "Debugger", closable: true }, { id: "terminal-editor", title: "Terminal", closable: true }],
    streaming: [
  ...
  const sidebarItems = {
    ...
    run: ["Active Tasks", "Saved Tasks", "Background Agents", "Tests", "Build", "Launch", "Debug Sessions", "Breakpoints", "Watch", "Processes", "Terminal"],
  ...
  const sidebarGroups = {
    ...
    run: [{ title: "Run & Test", items: ["Active Tasks", "Saved Tasks", "Background Agents", "Tests", "Build", "Launch"] }, { title: "Debug", items: ["Debug Sessions", "Breakpoints", "Watch", "Processes"] }, { title: "Terminal", items: ["Terminal"] }],
